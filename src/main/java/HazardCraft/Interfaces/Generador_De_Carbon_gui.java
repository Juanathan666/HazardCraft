...
public class Generador_De_Carbon_gui extends GuiContainer
{
	private static final ResourceLocation TEXTURES = new ResourceLocation(HazardCraft.MODID + ":textures/gui/generador_de_carbonpng");
	private final InventoryPlayer player;
	private final TileEntity_Generador tileentity;
	
	public Generador_De_Carbon_gui(InventoryPlayer player, TileEntity_Generador tileentity) 
	{
		super(new Container_Generador_de_carbon(player, tileentity));
		this.player = player;
