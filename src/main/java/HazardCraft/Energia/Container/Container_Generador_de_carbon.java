package HazardCraft.Energia.Container;
...
public class Container_Generador_de_carbon extends Container
{
	private final TileEntity_Generador tileentity;
	private int energy, cookTime;
	
	public Container_Generador_de_carbon(InventoryPlayer player, TileEntity_Generador tileentity) 
	{
