...
import HazardCraft.CreativeTabs.HazardCraftTab_Armaduras;
import HazardCraft.CreativeTabs.HazardCraftTab_Bloques;
import HazardCraft.CreativeTabs.HazardCraftTab_Cultivos;
import HazardCraft.CreativeTabs.HazardCraftTab_Herramientas;
import HazardCraft.CreativeTabs.HazardCraftTab_Magia;
import HazardCraft.CreativeTabs.HazardCraftTab_Minerales;
import HazardCraft.CreativeTabs.HazardCraftTab_Varitas;
...
public class HazardCraft 
{
    ...
    public static CreativeTabs HazardCraftTab_Cultivos = new HazardCraftTab_Cultivos(CreativeTabs.getNextID(), MODID, "HazardCraftTab_Cultivos", 6);
    public static CreativeTabs EventosTab = new HazardCraftTabEventos(CreativeTabs.getNextID(), MODID, "EventosTab", 7);
