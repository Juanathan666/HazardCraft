...
public class Lobo_demoniaco extends EntityMob
{
    ...
    private static final DataParameter<Boolean> IS_CHILD = EntityDataManager.<Boolean>createKey(Lobo_demoniaco.class, DataSerializers.BOOLEAN);
    /**
     * Was the type of villager for zombie villagers prior to 1.11. Now unused. Use {@link
     * EntityZombieVillager#PROFESSION} instead.
     */
    private static final DataParameter<Integer> VILLAGER_TYPE = EntityDataManager.<Integer>createKey(Lobo_demoniaco.class, DataSerializers.VARINT);
    private static final DataParameter<Boolean> ARMS_RAISED = EntityDataManager.<Boolean>createKey(Lobo_demoniaco.class, DataSerializers.BOOLEAN);
    ...
    {
        EntityLiving.registerFixesMob(fixer, Lobo_demoniaco.class);
    }
