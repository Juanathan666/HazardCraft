...
public class Espiritu_Ancestral extends EntityMob
{
    ...
    public Espiritu_Ancestral(World worldIn)
    {
        super(worldIn);
    ...
    protected void dropFewItems(boolean wasRecentlyHit, int lootingModifier) 
    {
    	...
    	int prob = rand.nextInt(100); //coge del 0 al 99
    	
    	
    	if(prob > 90)
    	{
    		this.entityDropItem(new ItemStack(Items.STRING), 1);
    	}
