...
public class varita_de_caida_lenta_principiante extends ItemBase {
	...
	public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
			...
			if(player.getHeldItem(hand.MAIN_HAND).getItem().equals(Items.VARITA_DE_CAIDA_LENTA_PRINCIPIANTE)) {
			
		funcion_varita(world, player, hand, "main");
		}else if(player.getHeldItem(hand.OFF_HAND).getItem().equals(Items.VARITA_DE_CAIDA_LENTA_PRINCIPIANTE)) {
