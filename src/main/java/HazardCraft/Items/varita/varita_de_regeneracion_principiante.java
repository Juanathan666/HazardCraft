...
public class varita_de_regeneracion_principiante extends ItemBase {
	...
	public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
			...
			if(player.getHeldItem(hand.MAIN_HAND).getItem().equals(Items.VARITA_DE_REGENERACION_PRINCIPIANTE)) {
			
		funcion_varita(world, player, hand, "main");
		}else if(player.getHeldItem(hand.OFF_HAND).getItem().equals(Items.VARITA_DE_REGENERACION_PRINCIPIANTE)) {
