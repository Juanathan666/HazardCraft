...
public class Armadura_netherita_base extends ItemArmor implements Modelos {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer player, EnumHand handIn) {
		...
		if(casco.isEmpty() && (player.getHeldItemMainhand().getItem() == Armaduras.casco_de_netherita || player.getHeldItemOffhand().getItem() == Armaduras.casco_de_netherita)) {
              sonido(worldIn, player);
		}
		if(pechera.isEmpty() && (player.getHeldItemMainhand().getItem() == Armaduras.pechera_de_netherita || player.getHeldItemOffhand().getItem() == Armaduras.pechera_de_netherita)) {
			  sonido(worldIn, player);
		}
		if(grebas.isEmpty() && (player.getHeldItemMainhand().getItem() == Armaduras.grebas_de_netherita || player.getHeldItemOffhand().getItem() == Armaduras.grebas_de_netherita)) {
			  sonido(worldIn, player);
		}
		if(botas.isEmpty() && (player.getHeldItemMainhand().getItem() == Armaduras.botas_de_netherita || player.getHeldItemOffhand().getItem() == Armaduras.botas_de_netherita)) {
			  sonido(worldIn, player);
		}	
