...
public class varita_de_caida_lenta_maestro extends Registro_Items {

	private static final int durabilidad = 40;
	
	public varita_de_caida_lenta_maestro(String name) 
	{
		super(name);
	...
	{
		if(player.getHeldItem(hand.MAIN_HAND).getItem().equals(Items_Magia_Varitas.VARITA_DE_CAIDA_LENTA_MAESTRO)) 
		{
			funcion_varita(world, player, hand, "main");
		}
		else if(player.getHeldItem(hand.OFF_HAND).getItem().equals(Items_Magia_Varitas.VARITA_DE_CAIDA_LENTA_MAESTRO)) 
		{
