...
public class varita_de_regeneracion_experto extends Registro_Items {
	...
	{
		if(player.getHeldItem(hand.MAIN_HAND).getItem().equals(Items_Magia_Varitas.VARITA_DE_REGENERACION_EXPERTO)) 
		{
			funcion_varita(world, player, hand, "main");
		}
		else if(player.getHeldItem(hand.OFF_HAND).getItem().equals(Items_Magia_Varitas.VARITA_DE_REGENERACION_EXPERTO)) 
		{
