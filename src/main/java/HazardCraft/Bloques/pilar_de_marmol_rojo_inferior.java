...
public class pilar_de_marmol_rojo_inferior extends BlockBase {
	...
	public void onBlockDestroyedByPlayer(World world, BlockPos pos, IBlockState state) {
		PilarBase_estados.inferior_onblock_destroyed(world, pos, state, Bloques.PILAR_DE_MARMOL_ROJO_INFERIOR, Bloques.PILAR_DE_MARMOL_ROJO_SUPERIOR, Bloques.PILAR_DE_MARMOL_ROJO);
